...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#list01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1625, stagger: 750, staggerOrder: '', replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 5, delay: 4250, staggerOrder: '', replay: false });
		onvisible.add('#icons02', { style: 'blur-in', speed: 1000, intensity: 5, delay: 4500, stagger: 875, staggerOrder: '', replay: false });
