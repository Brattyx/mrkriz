...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#container02', { style: 'blur-in', speed: 1625, intensity: 5, threshold: 3, delay: 125, replay: false });
		onvisible.add('#container01', { style: 'blur-in', speed: 1625, intensity: 5, threshold: 3, delay: 125, replay: false });
		onvisible.add('#container03', { style: 'blur-in', speed: 1625, intensity: 5, threshold: 3, delay: 125, replay: false });
		onvisible.add('#text01', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 500, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1250, replay: false });
		onvisible.add('#list01', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 1625, stagger: 750, staggerSelector: ':scope ul > li, :scope ol > li', replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 4250, replay: false });
		onvisible.add('#icons02', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 4500, stagger: 875, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#image01', { style: 'blur-in', speed: 2250, intensity: 6, threshold: 3, delay: 125, replay: false });
